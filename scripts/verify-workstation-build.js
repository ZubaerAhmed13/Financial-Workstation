...
const start=html.indexOf('FINANCIAL_CERTIFICATION_RUNTIME_START'),end=html.indexOf('FINANCIAL_CERTIFICATION_RUNTIME_END');
const workstationRoute=html.indexOf('workstationInstalled:Object.freeze(installed.slice())');
const simulationCore=html.indexOf('root.SimulationBacktestCore=api');
const checks=[
 ...
 ['SimulationBacktestCore embedded',html.includes('root.SimulationBacktestCore=api')],
 ...
 ['simulation/backtest version exposed',html.includes('App.meta.simulationBacktestCoreVersion=S.VERSION')&&html.includes('simulationBacktestVersion:S?S.VERSION:null')],
 ...
 ['Monte Carlo production route delegated',html.includes('MonteCarlo.run=cfg=>S.monteCarloRun(cfg)')],
 ['Backtest production route delegated',html.includes('BacktestEngine.run=cfg=>S.backtestRun(cfg)')],
 ...
 ['truthy scenario probability removed from generated legacy implementation',!html.includes('prob:s.prob||null')],
 ...
 ['valuation uncertainty margin typo removed from generated implementation',!html.includes('growth:g*.9,margin:m*.9')&&!html.includes('growth:g*1.1,margin:m*1.1')],
 ...
 ['simulation core occurs before workstation route installer',simulationCore>start&&simulationCore<workstationRoute],
 ['all final installers occur inside certification block',start>=0&&end>start&&workstationRoute>start&&workstationRoute<end],
 ['workstation installer follows legacy certification installer',workstationRoute>html.indexOf('Object.freeze(installReport)')]
];
